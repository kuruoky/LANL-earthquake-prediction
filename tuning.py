...
# LIGHTGBM PARAMETERS
LGBM_MAX_LEAVES = 2 ** 11  # maximum number of leaves per tree in LightGBM
EVAL_METRIC_LGBM_REG = 'mae'  # 'rmse' is a more common regression metric
EVAL_METRIC_LGBM_CLASS = 'auc'

# XGBOOST PARAMETERS
EVAL_METRIC_XGB_REG = 'mae'
EVAL_METRIC_XGB_CLASS = 'auc'
    ...
    if package == 'lgbm':
        ...
        boosting_list = [{'boosting': 'gbdt',
                         ...
                         {'boosting': 'goss',
                          ...
                          'other_rate': hp.uniform('other_rate', 0,
                                                   0.5)}]  # if including 'dart', make sure to set 'n_estimators'
